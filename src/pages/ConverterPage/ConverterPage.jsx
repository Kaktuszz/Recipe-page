    ...
    <Center>
      ...
      >
        ...
        <Box mt="20px" fontSize="sm" color="gray.600">
          <strong>Cooking Unit Converter</strong> helps you convert between
          common
          <em> weight </em> and <em> volume </em> measurements for ingredients
          like water, milk, sugar, flour, butter, and oil. It supports both
          metric and imperial units and adjusts results automatically using
          ingredient density.
          <br />
          <br />
